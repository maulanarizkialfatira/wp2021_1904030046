...
$id = $_GET['id'];
$cam = query("SELECT*FROM buku WHERE id=$id");
//var_dump($cam[0]);
...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!--konten-->
      <h3><i class="fas fa-table"></i>Detail Data Buku</h3>
      <hr>
      <ul class="list-group">
        <li class="list-group-item active"><?= $cam['nama']; ?></li>
        <li class="list-group-item">harga : <?= $cam['harga']; ?></li>
        <li class="list-group-item">stok : <?= $cam['stok']; ?></li>
        <li class="list-group-item">
          <td><img src="image/<?php echo $cam['foto']; ?>" width="120px"></td>
        </li>
        <li class="list-group-item">
          <a href="edit.php?id=<?= $cam['id']; ?>" class="btn btn-warning" role="button"><i class="fas fa-edit" width="50px"></i> Edit</a>
          <a href="hapus.php?id=<?= $cam['id']; ?>" class="btn btn-danger" role="button"><i class="fas fa-trash-alt" width="50px"></i> Hapus</a>
          <a href="buku.php" class="btn btn-primary role" role=" button"><i class="fas fa-arrow-left" width="50px"></i> Kembali</a>
        </li>
      </ul>
