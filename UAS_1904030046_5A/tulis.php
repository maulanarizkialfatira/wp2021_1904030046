...
$cam = query("SELECT*FROM tulis");

if (isset($_POST['cari'])) {
  $cam = carit($_POST['keyword']);
}
?>
          ...
          <tbody>
            ...
            foreach ($cam as $cmb) : ?>
              <tr>
                ...
                <td><?php echo $cmb['namat']; ?></td>
                <td><?php echo $cmb['hargat']; ?></td>
                <td><?php echo $cmb['stokt']; ?></td>
                <td><img src="image1/<?php echo $cmb['fotot']; ?>" width="50px"></td>
                <td><a class="btn btn-primary" role="button"><i class="fas fa-shopping-basket" width="50px"></i> Beli </a></td>
                <td><a href="detailt.php?idt=<?= $cmb['idt']; ?>" class="btn btn-warning" role="button"><i class="fas fa-info" width="50px"></i> Detail</a></td>
