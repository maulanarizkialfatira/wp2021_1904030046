    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama" value="<?= $cam['nama'] ?>" placeholder="nama barang" name="nama" autofocus required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="harga">Harga</label>
          <input type="text" class="form-control" id="harga" value="<?= $cam['harga'] ?>" placeholder="harga barang" name="harga" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="stok">Stok</label>
          <input type="text" class="form-control" id="stok" value="<?= $cam['stok'] ?>" placeholder="stok barang" name="stok" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="foto">Foto </label>
          <input type="text" class="form-control" id="foto" value="<?= $cam['foto'] ?>" placeholder="foto" name="foto" required autocomplete="off">
        </div>
